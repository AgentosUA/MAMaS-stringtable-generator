      ...
      <main>
        <section className='main-settings'>
          <div>
            ...
            <input name='title' value={title} onChange={(e) => setTitle(e.target.value)} placeholder='Название' />
          </div>
          <div>
            <span>Автор миссии</span>
            <input name='author' value={author} onChange={(e) => setAuthor(e.target.value)} placeholder='Автор' />
          </div>
          <div>
            <span>Условности миссии</span>
            <textarea name='conventions' value={conventions} onChange={(e) => setConventions(e.target.value)} placeholder='Условности' width='250px' />
          </div>
        </section>
